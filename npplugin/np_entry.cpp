...
static NPError fillNetscapeFunctionTable(NPNetscapeFuncs* aNPNFuncs)
{
  ...
  NPNFuncs.construct				= aNPNFuncs->construct;
  NPNFuncs.getvalueforurl			= aNPNFuncs->getvalueforurl;
  NPNFuncs.setvalueforurl			= aNPNFuncs->setvalueforurl;
  NPNFuncs.getauthenticationinfo 	= aNPNFuncs->getauthenticationinfo;
  NPNFuncs.scheduletimer			= aNPNFuncs->scheduletimer;
  NPNFuncs.unscheduletimer			= aNPNFuncs->unscheduletimer;
  NPNFuncs.popupcontextmenu			= aNPNFuncs->popupcontextmenu;
  NPNFuncs.convertpoint				= aNPNFuncs->convertpoint;
  ...
  NPNFuncs.handleevent				= aNPNFuncs->handleevent;
  NPNFuncs.unfocusinstance			= aNPNFuncs->unfocusinstance;
  NPNFuncs.urlredirectresponse		= aNPNFuncs->urlredirectresponse;
