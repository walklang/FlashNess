...
typedef struct _FlashNess_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } FlashNess_MIDL_TYPE_FORMAT_STRING;

typedef struct _FlashNess_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } FlashNess_MIDL_PROC_FORMAT_STRING;

typedef struct _FlashNess_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } FlashNess_MIDL_EXPR_FORMAT_STRING;
...
extern const FlashNess_MIDL_TYPE_FORMAT_STRING FlashNess__MIDL_TypeFormatString;
extern const FlashNess_MIDL_PROC_FORMAT_STRING FlashNess__MIDL_ProcFormatString;
extern const FlashNess_MIDL_EXPR_FORMAT_STRING FlashNess__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IFlashNess_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFlashNess_ProxyInfo;
...
static const FlashNess_MIDL_PROC_FORMAT_STRING FlashNess__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 274 */	NdrFcShort( 0x430 ),	/* Type Offset=1072 */
...
static const FlashNess_MIDL_TYPE_FORMAT_STRING FlashNess__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    FlashNess__MIDL_ProcFormatString.Format,
...
/* Object interface: IFlashNess, ver. 0.0,
   GUID={0x13953020,0xA524,0x47F3,{0x9C,0x07,0xD3,0x84,0xE0,0x38,0x0E,0xE3}} */

#pragma code_seg(".orpc")
static const unsigned short IFlashNess_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFlashNess_ProxyInfo =
    ...
    &Object_StubDesc,
    FlashNess__MIDL_ProcFormatString.Format,
    &IFlashNess_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFlashNess_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    FlashNess__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _IFlashNessProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IFlashNess::get_ReadShort */ ,
    (void *) (INT_PTR) -1 /* IFlashNess::get_ReadData */
};


static const PRPC_STUB_FUNCTION IFlashNess_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IFlashNessStubVtbl =
{
    &IID_IFlashNess,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    FlashNess__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _FlashNess_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFlashNessProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _FlashNess_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFlashNessStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _FlashNess_InterfaceNamesList[] = 
{
    "IFlashNess",
    "IComponentRegistrar",
    0
...
const IID *  const _FlashNess_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _FlashNess_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FlashNess, pIID, n)

int __stdcall _FlashNess_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FlashNess, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FlashNess, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FlashNess_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FlashNess_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FlashNess_StubVtblList,
    (const PCInterfaceName * ) & _FlashNess_InterfaceNamesList,
    (const IID ** ) & _FlashNess_BaseIIDList,
    & _FlashNess_IID_Lookup, 
    2,
    2,
